...
class Ui_simulator_dialog(object):
    def setupUi(self, simulator_dialog):
        ...
        simulator_dialog.resize(1113, 770)
        ...
        self.gridLayout_4.addItem(spacerItem2, 2, 7, 1, 1)
        ...
        simulator_dialog.setTabOrder(self.loadDeckConfigurationsButton, self.newCardsPerDaySpinbox)
        ...
        simulator_dialog.setTabOrder(self.maximumIntervalSpinbox, self.includeSuspendedNewCardsCheckbox)
        simulator_dialog.setTabOrder(self.includeSuspendedNewCardsCheckbox, self.includeOverdueCardsCheckbox)
        simulator_dialog.setTabOrder(self.includeOverdueCardsCheckbox, self.simulationTitleTextfield)
        ...
        simulator_dialog.setTabOrder(self.simulateButton, self.clearLastSimulationButton)
    ...
    def retranslateUi(self, simulator_dialog):
        ...
        self.label_5.setText(_translate("simulator_dialog", "<b>Your Performance</b>"))
