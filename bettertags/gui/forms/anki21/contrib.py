...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/bettertags/icons/coffee.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/bettertags/icons/email.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/bettertags/icons/patreon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/bettertags/icons/heart.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.fmtLabHeader.setText(_translate("Dialog", "<html><head/><body><p>Hi! <span style=\" font-weight:600;\">Glutanimate</span> here :). Thanks for checking out BetterTags and some of my other add-ons. I hope you\'ve been enjoying them! </p><p>If <span style=\" font-weight:600;\">{ADDON_NAME}</span> or any of <a href=\"https://ankiweb.net/shared/byauthor/1046608507\"><span style=\" text-decoration: underline; color:#2980b9;\">my other projects</span></a> has been a valuable asset in your studies, please do consider <span style=\" font-weight:600;\">supporting my work</span> through one of the methods below:</p></body></html>"))
