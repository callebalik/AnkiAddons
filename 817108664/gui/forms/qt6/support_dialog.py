...
class Ui_support_dialog(object):
    def setupUi(self, support_dialog):
        ...
        self.label = QtWidgets.QLabel(parent=support_dialog)
        ...
        self.giovanniButton = QtWidgets.QPushButton(parent=support_dialog)
        font = QtGui.QFont()
        ...
        self.glutanimateButton = QtWidgets.QPushButton(parent=support_dialog)
        font = QtGui.QFont()
        ...
        self.label_4 = QtWidgets.QLabel(parent=support_dialog)
        self.label_4.setWordWrap(True)
        self.label_4.setObjectName("label_4")
        self.verticalLayout.addWidget(self.label_4)
        spacerItem2 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.verticalLayout.addItem(spacerItem2)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=support_dialog)
        ...
        self.buttonBox.accepted.connect(support_dialog.accept) # type: ignore
        self.buttonBox.rejected.connect(support_dialog.reject) # type: ignore
